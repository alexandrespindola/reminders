...
<div>
    <form wire:submit.prevent="submit" class="space-y-4">
        ...
        <x-textarea wire:model="reminderDescription" label="Description" placeholder="Say something about your reminder..." />
        <x-select wire:model="reminderNotificationType" label="Select Reminder Type" placeholder="Select one" :options="[
            ['name' => 'E-mail', 'value' => 'email'],
        ]" option-label="name" option-value="value"/>
        <x-input wire:model="reminderEmailRecipient" label="E-mail Recipient" type="email" placeholder="youremail@gmail.com" icon="user" />
        <x-datetime-picker wire:model.live="reminderReminderTime" label="Appointment Date" placeholder="Appointment Date" />
        <div class="pt-4">
